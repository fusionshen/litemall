...
Page({
  ...
  toAgree: function (e) {
    ...
    let heartNum = this.data.heartNum  
    if(heart) {
      heartNum += 1 
    }else{
      heartNum -= 1
    }
    this.setData({ heart,heartNum })
  },
  // 评论
  toComment: function (e) {
    let doComment = !this.data.doComment
    this.setData({ doComment })
  },
  // 分享
  toShare: function (e) {
    let doShare = !this.data.doShare
    this.setData({ doShare })
  },
  // 页面分享
